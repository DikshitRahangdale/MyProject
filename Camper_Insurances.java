...
public class Camper_Insurances {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		driver.findElement(By.id("engineperformance")).sendKeys("250");
		...
		List<WebElement> drive = driver
				.findElements(By.xpath("//*[@id='insurance-form']/div/section[1]/div[5]/p/label"));
		drive.get(0).click();
		...
		List<WebElement> gender = driver
				.findElements(By.xpath("//*[@id='insurance-form']/div/section[2]/div[4]/p/label"));
		gender.get(0).click();
		...
		List<WebElement> hob = driver
				.findElements(By.xpath("//*[@id='insurance-form']/div/section[2]/div[10]/p/label"));
		hob.get(3).click();
		hob.get(4).click();
		...
		if ((actprice.equals(price)) && (claim.equals(expclaim)) && (disc.equals(discount))
			...
			FileUtils.copyFile(shot, new File("C:\\Users\\ADMIN\\Pictures\\Screenshots\\Camper.JPEG"));
